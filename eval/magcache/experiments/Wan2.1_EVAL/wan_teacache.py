...
def generate(args, prompt_list=None, save_dir=None):
    ...
    if "t2v" in args.task or "t2i" in args.task:
        ...
        wan_t2v.model.__class__.enable_teacache = args.enable_teacache
        ...
        wan_i2v.model.__class__.enable_teacache = args.enable_teacache
